...
const TOKEN_DECIMALS = ethers.BigNumber.from("10").pow(ethers.BigNumber.from("18"))
...
const TWENTY_MILLION = ethers.BigNumber.from("20").mul(MILLION).mul(TOKEN_DECIMALS)
const PARTNER_MAX = ethers.BigNumber.from("78").mul(MILLION).mul(TOKEN_DECIMALS)

const TEAM_MULTISIG = "0x9b9E328B0bED9cdB037f7a9D5D86A58f9AC29e25"
const TEAM_EOA = "0x9b9E328B0bED9cdB037f7a9D5D86A58f9AC29e25"

const testArbitrumArgs = {
    // Chain const
    //   lzChainId: 10011,
...
export default testArbitrumArgs
